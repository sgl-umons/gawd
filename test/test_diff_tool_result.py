...
def compare_results(first, second):
    ...
    first = [
        (k, gawd.path_to_string(op), ov, gawd.path_to_string(np), nv) for k, op, ov, np, nv in first
    ]
...
class TestDiffTool:
    def test_result_1(self):
        ...
        expected_result = [
            ("changed", "jobs.golangci.name", "Golangci-Lint", "jobs.golangci.name", "lint"),
            (
                "moved",
                "jobs.golangci.steps[0]",
                {"uses": "actions/checkout@v2"},
                "jobs.golangci.steps[1]",
                {"uses": "actions/checkout@v3"},
            ),
            (
                "changed",
                "jobs.golangci.steps[0].uses",
                "actions/checkout@v2",
                "jobs.golangci.steps[1].uses",
                "actions/checkout@v3",
            ),
            (
                "moved",
            ...
            (
                "changed",
                "jobs.golangci.steps[1].name",
                "Run golangci-lint",
                "jobs.golangci.steps[2].name",
                "golangci-lint",
            ),
            (
                "changed",
                ...
                "jobs.golangci.steps[2].uses",
                "golangci/golangci-lint-action@v3",
            ),
            (
                "changed",
                "jobs.golangci.steps[1].with.version",
                "v1.40",
                "jobs.golangci.steps[2].with.version",
                "v1.45",
            ),
        ...
        assert compare_results(
            gawd.diff_workflow_files(old_workflow, new_workflow), expected_result
        )
    ...
    def test_result_3(self):
        ...
        expected_result = [
            ("changed", "name", "CodeQL", "name", "CodeQL - Code Analysis"),
            ...
            (
                ...
                "jobs.analyze",
                {
                    ...
                    "strategy": {"fail-fast": False, "matrix": {"language": ["csharp"]}},
                    "steps": [
            ...
            (
                ...
                None,
                None,
                "jobs.analyze.strategy",
                {"fail-fast": False, "matrix": {"language": ["csharp"]}},
            ),
            ("changed", "jobs.analyse.name", "Analyse", "jobs.analyze.name", "Analyze"),
            (
                "moved",
                "jobs.analyse.steps[3]",
                {"name": "Autobuild", "uses": "github/codeql-action/autobuild@v1"},
                "jobs.analyze.steps[2]",
                {"name": "Autobuild", "uses": "github/codeql-action/autobuild@v2"},
            ),
            (
                "changed",
                "jobs.analyse.steps[3].uses",
                "github/codeql-action/autobuild@v1",
                "jobs.analyze.steps[2].uses",
                "github/codeql-action/autobuild@v2",
            ),
            (
                "moved",
                "jobs.analyse.steps[4]",
                {"name": "Perform CodeQL Analysis", "uses": "github/codeql-action/analyze@v1"},
                "jobs.analyze.steps[3]",
                {"name": "Perform CodeQL Analysis", "uses": "github/codeql-action/analyze@v2"},
            ),
            (
                "changed",
                "jobs.analyse.steps[4].uses",
                "github/codeql-action/analyze@v1",
                "jobs.analyze.steps[3].uses",
                "github/codeql-action/analyze@v2",
            ),
            (
                "moved",
                "jobs.analyse.steps[2]",
                {
                    "name": "Initialize CodeQL",
                    "uses": "github/codeql-action/init@v1",
                    "with": {"languages": "csharp"},
                },
                "jobs.analyze.steps[1]",
                {
                    "name": "Initialize CodeQL",
                    "uses": "github/codeql-action/init@v2",
                    "with": {"languages": "${{ matrix.language }}"},
            ...
            (
                "changed",
                "jobs.analyse.steps[2].uses",
                "github/codeql-action/init@v1",
                "jobs.analyze.steps[1].uses",
                "github/codeql-action/init@v2",
            ),
            (
                "changed",
                "jobs.analyse.steps[2].with.languages",
                "csharp",
                "jobs.analyze.steps[1].with.languages",
                "${{ matrix.language }}",
            ),
            ("removed", "jobs.analyse.steps[0].with", {"fetch-depth": 2}, None, None),
            (
                "changed",
                "jobs.analyse.steps[0].uses",
                "actions/checkout@v2",
            ...
            (
                "removed",
                "jobs.analyse.steps[1]",
                {"run": "git checkout HEAD^2", "if": "${{ github.event_name == 'pull_request' }}"},
                None,
                None,
            ),
        ]
    ...
    def test_result_5(self):
        ...
        expected_result = [
            (
                "changed",
                "on.workflow_dispatch.inputs.imageVersion.default",
                "v0.3.0",
                "on.workflow_dispatch.inputs.imageVersion.default",
                "v1.CHANGE_ME",
            )
    ...
    def test_result_6(self):
        ...
        expected_result = [
            ("removed", "on.push.branches[1]", "master", None, None),
            (
                "changed",
                "jobs.docker_push_dev.if",
    ...
    def test_result_7(self):
        ...
        expected_result = [
            ("added", None, None, "jobs.goreleaser.steps[4].name", "release a new version"),
            ...
            (
                ...
                None,
                None,
                "jobs.goreleaser.steps[5].name",
                "test releasing a snapshot version",
            ),
    ...
    def test_result_8(self):
        ...
        expected_result = [
            ("changed", "on.push", None, "on.push", {"branches": ["master", "main", "dev/*"]}),
            (
                "changed",
                "jobs.linux-build.runs-on",
                "ubuntu-20.04",
                "jobs.linux-build.runs-on",
                "ubuntu-latest",
            ),
    ...
    def test_result_11(self):
        ...
        expected_result = [
            ("changed", "on.push", {"branches": ["*"]}, "on.push", None),
            (
                "changed",
    ...
    def test_result_13(self):
        ...
        expected_result = [
            (
                "changed",
                "jobs.dependabot-merge.steps[0].uses",
                "dependabot/fetch-metadata@v1.3.6",
                "jobs.dependabot-merge.steps[0].uses",
                "dependabot/fetch-metadata@v1.4.0",
            )
        ]
    ...
    def test_result_15(self):
        ...
        expected_result = [
            (
                "changed",
                "jobs.update_draft_release.steps[0].uses",
                "toolmantim/release-drafter@v5.13.0",
                "jobs.update_draft_release.steps[0].uses",
                "toolmantim/release-drafter@v5.14.0",
            )
        ]
    ...
    def test_result_16(self):
        ...
        expected_result = [
            (
                "changed",
                "jobs.size.steps[2].uses",
                "posva/size-check-action@master",
                "jobs.size.steps[2].uses",
                "posva/size-check-action@v1.1.0",
            )
        ]
    ...
    def test_result_17(self):
        ...
        expected_result = [
            (
                "changed",
                "jobs.docs-build.uses",
                "rapidsai/shared-action-workflows/.github/workflows/custom-job.yaml@branch-23.04",
                "jobs.docs-build.uses",
                "rapidsai/shared-action-workflows/.github/workflows/custom-job.yaml@branch-23.06",
            ),
            (
                "changed",
                "jobs.upload-conda.uses",
                "rapidsai/shared-action-workflows/.github/workflows/conda-upload-packages.yaml@branch-23.04",
                "jobs.upload-conda.uses",
                "rapidsai/shared-action-workflows/.github/workflows/conda-upload-packages.yaml@branch-23.06",
            ),
            (
                "changed",
                "jobs.conda-python-build.uses",
                "rapidsai/shared-action-workflows/.github/workflows/conda-python-build.yaml@branch-23.04",
                "jobs.conda-python-build.uses",
                "rapidsai/shared-action-workflows/.github/workflows/conda-python-build.yaml@branch-23.06",
            ),
        ]
    ...
    def test_result_18(self):
        ...
        expected_result = [
            ...
            (
                ...
                "jobs.build-stable",
                {
                    ...
                    "steps": [
                        ...
                        {
                            "uses": "actions-rs/toolchain@v1",
                            "with": {"toolchain": "1.41.0", "profile": "minimal", "override": True},
                        },
                        {"name": "Test", "run": "make test-141"},
                    ],
                },
                "jobs.test-stable",
                {
                    ...
                    "steps": [
                        ...
                        {
                            "uses": "actions-rs/toolchain@v1",
                            "with": {"toolchain": "1.46.0", "profile": "minimal", "override": True},
                        },
                        {"name": "Test", "run": "make test"},
                    ],
                },
            ...
            (
                "changed",
                "jobs.build-stable.name",
                "Test on 1.41.0",
                "jobs.test-stable.name",
                "Test on 1.46.0",
            ),
            (
                "changed",
                "jobs.build-stable.steps[1].with.toolchain",
                "1.41.0",
                "jobs.test-stable.steps[1].with.toolchain",
                "1.46.0",
            ),
            (
                "changed",
                "jobs.build-stable.steps[2].run",
                "make test-141",
                "jobs.test-stable.steps[2].run",
                "make test",
            ),
        ]
    ...
    def test_result_19(self):
        ...
        expected_result = [
                ...
                "jobs.build-compat",
                {
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "with": {"name": "build-reports", "path": "compat/app/build/reports"},
                        },
                    ],
                },
                "jobs.build-all",
            ...
            (
                "changed",
                "jobs.build-compat.steps[2].run",
                "cd compat && ./gradlew assembleDebug lintDebug",
                "jobs.build-all.steps[2].run",
                'find . -name "gradlew" -exec ./{} assembleDebug lintDebug \\;',
            ),
            (
                "removed",
                "jobs.build-compat.steps[3]",
                {
                    "name": "Upload build reports",
                    "if": "always()",
                    "uses": "actions/upload-artifact@v1",
        ...
        expected_result = [
            (
                ...
                "jobs.linux-x64",
                {
                    ...
                    "container": {"image": "ilegeul/ubuntu:amd64-18.04-xbb-v5.0.0"},
                    ...
                    "steps": [
                        ...
                        {"name": "Clean working area", "run": "rm -rf * .git*"},
                        {
                ...
                "jobs.linux-x64-x",
                {
                    "name": "Linux Intel X - OpenOCD ${{ github.event.inputs.version }} build",
                    "timeout-minutes": 5760,
                    "runs-on": ["self-hosted", "linux", "x64"],
                    "container": {"image": "ilegeul/ubuntu:amd64-18.04-xbb-v5.0.0"},
                    "defaults": {"run": {"shell": "bash"}},
            ...
            (
                "changed",
                "jobs.linux-x64.name",
                "Linux Intel - OpenOCD ${{ github.event.inputs.version }} build",
                "jobs.linux-x64-x.name",
                "Linux Intel X - OpenOCD ${{ github.event.inputs.version }} build",
            ),
            (
                "moved",
                "jobs.linux-x64.steps[8]",
                {
                    "name": "Rename working area",
                    "run": "mv -v build build-$(date -u +%Y%m%d-%H%M%S)",
                },
                "jobs.linux-x64-x.steps[7]",
                {
                    "name": "Rename working area",
                    "run": "mv -v build build-$(date -u +%Y%m%d-%H%M%S)",
                },
            ...
            (
                "changed",
                "jobs.linux-x64.steps[7].with.artifacts",
                "build/linux-x64/deploy/*,build/win32-x64/deploy/*",
                "jobs.linux-x64-x.steps[6].with.artifacts",
                "build/linux-x64/deploy/*",
            ),
            (
                "removed",
                "jobs.linux-x64.steps[6]",
                {
                    "name": "Build Windows x64 binary",
                    "timeout-minutes": 1440,
                    "run": "xpm install --config win32-x64\nxpm run build --config win32-x64\n",
            ...
            (
                ...
                "jobs.linux-x64-w",
                {
                    "name": "Linux Intel W - OpenOCD ${{ github.event.inputs.version }} build",
                    "timeout-minutes": 5760,
                    "runs-on": ["self-hosted", "linux", "x64"],
                    "container": {"image": "ilegeul/ubuntu:amd64-18.04-xbb-v5.0.0"},
                    "defaults": {"run": {"shell": "bash"}},
    ...
    def test_result_21(self):
        ...
        expected_result = [
            (
                "changed",
                "jobs.build-linux-clangpdb-gcc5.steps[1].run",
            ...
            (
                "renamed",
                "jobs.build-linux-clang38",
                {
                    "name": "Build Linux CLANG38",
                    "runs-on": "ubuntu-latest",
                    "env": {"TOOLCHAINS": "CLANG38"},
                    "steps": [
                        {"uses": "actions/checkout@v2"},
                        {
                        ...
                        {
                            "name": "Build Docs",
                            "run": "abort() { tail -200 log.txt ; exit 1 ; }\ndoxygen Doxyfile &> log.txt || abort\ncd Doxy/latex || abort\nmake pdf &> log.txt || abort\n",
                        },
                        {
                            "name": "Upload to Artifacts",
                            "uses": "actions/upload-artifact@v2",
                            "with": {"name": "Linux CLANG38 Artifacts", "path": "Binaries/*.zip"},
                        },
                    ],
                },
                "jobs.build-linux-clangdwarf",
                {
            ...
            (
                "changed",
                "jobs.build-linux-clang38.env.TOOLCHAINS",
                "CLANG38",
                "jobs.build-linux-clangdwarf.env.TOOLCHAINS",
                "CLANGDWARF",
            ),
            (
                "changed",
                "jobs.build-linux-clang38.steps[6].with.name",
                "Linux CLANG38 Artifacts",
                "jobs.build-linux-clangdwarf.steps[6].with.name",
    ...
    def test_result_22(self):
        ...
        expected_result = [
            (
                "renamed",
                "jobs.github-actions-automate-projects",
                {
                    "runs-on": "ubuntu-latest",
                    "steps": [
                        {
            ...
            (
                "removed",
                "jobs.github-actions-automate-projects.steps[0]",
                {
                    "name": "add-new-issues-to-repository-based-project-column",
                    "uses": "docker://takanabe/github-actions-automate-projects:v0.0.1",
                    "if": "github.event_name == 'issues' && github.event.action == 'opened'",
            ...
            (
                "removed",
                "jobs.github-actions-automate-projects.steps[1]",
                {
                    "name": "add-new-prs-to-repository-based-project-column",
                    "uses": "docker://takanabe/github-actions-automate-projects:v0.0.1",
                    "if": "github.event_name == 'pull_request' && github.event.action == 'opened'",
            ...
            (
                ...
                None,
                None,
                "jobs.gh-automate-projects.steps[0]",
                {
                    "name": "Add new issue to the Backlog 🗂  project board",
                    "if": "github.event_name == 'issues' && github.event.action == 'opened'",
                    "run": 'gh issue edit $ISSUE --add-project "Backlog 🗂  "',
            ...
            (
                ...
                None,
                None,
                "jobs.gh-automate-projects.steps[1]",
                {
                    "name": "Add new pull request to the Pull Requests project board",
                    "if": "github.event_name == 'pull_request' && github.event.action == 'opened'",
                    "run": 'gh pr edit $PULL_REQUEST --add-project "Pull Requests"',
    ...
    def test_result_23(self):
        ...
        expected_result = [
            (
                "changed",
                "name",
                "Test Python aswfdocker Library - Sonar",
                "name",
                "Test Python aswfdocker Library",
            ),
            (
                "removed",
                "on.pull_request",
            ...
            ("changed", "on.push", {"branches": ["master"]}, "on.push", None),
            (
                "changed",
                "jobs.release.steps[4].run",
                "pipenv run pytest python/aswfdocker --doctest-modules --junitxml=test-pytest-results.xml --cov=. --cov-report=xml",
                "jobs.release.steps[4].run",
                "pipenv run pre-commit run --all-files",
            ),
            (
                "changed",
                "jobs.release.steps[4].name",
                "Run pytest",
                "jobs.release.steps[4].name",
            ...
            (
                "removed",
                "jobs.release.steps[7]",
                {"run": "pipenv run black python --check", "name": "Run black checker"},
                None,
                None,
            ),
            (
                "removed",
                "jobs.release.steps[8]",
                {
            ...
            (
                ...
                "jobs.test-alpine",
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "test",
                            "run": "apk add tcl procps\n./runtest --accurate --verbose --dump-logs\n",
                        },
                        {"name": "module api test", "run": "./runtest-moduleapi --verbose"},
                        {"name": "sentinel tests", "run": "./runtest-sentinel"},
                        {"name": "cluster tests", "run": "./runtest-cluster"},
                    ],
                },
                "jobs.test-alpine-jemalloc",
                {
                    "runs-on": "ubuntu-latest",
                    "container": "alpine:latest",
                    "steps": [
    ...
    def test_result_25(self):
        ...
        expected_result = [
            (
                ...
                None,
                "env",
                {"ARKOUDA_DEVELOPER": True, "CHPL_RT_OVERSUBSCRIBED": "yes"},
            ),
            (
                "renamed",
                "jobs.lint_job",
            ...
            (
                "changed",
                "jobs.lint_job.steps[0].uses",
                "actions/checkout@v1",
                "jobs.lint.steps[0].uses",
                "actions/checkout@v2",
            ),
            (
                "changed",
                "jobs.lint_job.steps[1].name",
                "look for tabs",
                "jobs.lint.steps[1].name",
                "Check for tabs",
            ),
            (
                "renamed",
                ...
                {
                    "runs-on": "ubuntu-latest",
                    "container": {"image": "chapel/chapel:1.20.0"},
                    "steps": [
                        {"uses": "actions/checkout@v1"},
                        {
                            "name": "linux comm=none",
                            "run": 'apt-get update && apt-get install -y libhdf5-dev libzmq3-dev python3-pip\necho "\\$(eval \\$(call add-path,/usr/lib/x86_64-linux-gnu/hdf5/serial/))" > Makefile.paths\nARKOUDA_DEVELOPER=true make\npip3 install -e .\nmake check\n',
                        },
                    ],
                },
                "jobs.arkouda_tests_linux",
                {
                    "runs-on": "ubuntu-latest",
                    "container": {"image": "chapel/chapel:1.20.0"},
                    "steps": [
            ...
            (
                "changed",
                "jobs.linux_job.steps[0].uses",
                "actions/checkout@v1",
                "jobs.arkouda_tests_linux.steps[0].uses",
                "actions/checkout@v2",
            ),
            (
                "changed",
                "jobs.linux_job.steps[1].name",
                "linux comm=none",
                "jobs.arkouda_tests_linux.steps[1].name",
                "Install dependencies",
            ),
            (
                "changed",
                "jobs.linux_job.steps[1].run",
                'apt-get update && apt-get install -y libhdf5-dev libzmq3-dev python3-pip\necho "\\$(eval \\$(call add-path,/usr/lib/x86_64-linux-gnu/hdf5/serial/))" > Makefile.paths\nARKOUDA_DEVELOPER=true make\npip3 install -e .\nmake check\n',
                "jobs.arkouda_tests_linux.steps[1].run",
                'apt-get update && apt-get install -y libhdf5-dev libzmq3-dev python3-pip\necho "\\$(eval \\$(call add-path,/usr/lib/x86_64-linux-gnu/hdf5/serial/))" > Makefile.paths\n',
            ),
            (
                "added",
                None,
                None,
                "jobs.arkouda_tests_linux.steps[2]",
                {"name": "Build/Install Arkouda", "run": "make\npip3 install -e .\n"},
            ),
            (
                "added",
                None,
                None,
                "jobs.arkouda_tests_linux.steps[3]",
                {"name": "Arkouda make check", "run": "make check\n"},
            ),
        ]
    ...
    def test_result_26(self):
        ...
        expected_result = [
            (
                ...
                {
                    "runs-on": "ubuntu-latest",
                    "defaults": {"run": {"working-directory": "kong-mesh"}},
                    "steps": [
                        {
                        ...
                        {"name": "Clone Kuma", "uses": "actions/checkout@v2"},
                        {"uses": "actions/setup-go@v2", "with": {"go-version": "~1.18.1"}},
                        {
                            "run": "go run ./tools/releases/changelog/... changelog.md > CHANGELOG.md\n"
                        },
                        {
                ...
                "jobs.update-changelog",
                {
                    ...
                    "steps": [
                        ...
                        {"uses": "actions/setup-go@v2", "with": {"go-version": "~1.18.1"}},
                        {
                            "env": {"GITHUB_TOKEN": "${{ steps.github-app-token.outputs.token }}"},
                            "run": "go run ./tools/releases/changelog/... changelog.md > CHANGELOG.md\n",
                        },
                        {
                            "name": "Create Pull Request",
            ...
            (
                "removed",
                "jobs.upgrade-kuma.defaults",
                {"run": {"working-directory": "kong-mesh"}},
                None,
                None,
            ),
            (
                ...
                None,
                None,
                "jobs.update-changelog.steps[3].env",
    ...
    def test_result_27(self):
        ...
        expected_result = [
            (
                ...
                "jobs.test",
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "make",
                            "run": "sudo apt-get -y install uuid-dev libcurl4-openssl-dev\nmake -j8\n",
                        },
                        {
                            "name": "test 20x",
            ...
            (
                ...
                "jobs.test-endurance.steps[2].run",
                "sudo apt-get install tcl8.5\n./runtest --loopn 20 --clients 10\n",
            ),
        ]
    ...
    def test_result_28(self):
        ...
        expected_result = [
            (
                "removed",
                "jobs.gateway.steps[2]",
                {
                    "name": "Get dependencies",
                    "run": "cd gateway && go get -v -t -d ./...\nif [ -f Gopkg.toml ]; then\n    curl https://raw.githubusercontent.com/golang/dep/master/install.sh | sh\n    dep ensure\nfi\n",
                },
                None,
                None,
            ),
            ...
            (
                ...
                {
                    "name": "Get dependencies",
                    "run": "cd metric-proxy && go get -v -t -d ./...\nif [ -f Gopkg.toml ]; then\n    curl https://raw.githubusercontent.com/golang/dep/master/install.sh | sh\n    dep ensure\nfi\n",
                },
                None,
                None,
            ),
            ...
            (
                ...
                "jobs.cli",
                {
                    ...
                    "steps": [
                        ...
                        {"name": "Build", "run": "cd space-cli && go build -v ."},
                        {"name": "Test", "run": "cd space-cli && go test ./..."},
                        {
                            "name": "Lint",
        ...
        expected_result = [
            (
                ...
                "jobs.build.steps[1]",
                {
                    ...
                    "with": {"java-version": 8, "distribution": "temurin", "cache": "maven"},
                },
                "jobs.build.steps[2]",
                {
                    "name": "Set up Java 8",
                    "uses": "actions/setup-java@v3",
                    "with": {"java-version": 8, "distribution": "temurin", "cache": "gradle"},
                },
            ),
            (
                "changed",
                "jobs.build.steps[1].with.cache",
                "maven",
                "jobs.build.steps[2].with.cache",
                "gradle",
            ),
            (
                "moved",
                "jobs.build.steps[2]",
                {"name": "Build library with Maven", "run": "mvn -B verify"},
                "jobs.build.steps[3]",
                {"name": "Build libraries with Gradle", "run": "./gradlew clean build"},
            ),
            (
                "changed",
                "jobs.build.steps[2].name",
                "Build library with Maven",
                "jobs.build.steps[3].name",
                "Build libraries with Gradle",
            ),
            (
                "changed",
                "jobs.build.steps[2].run",
                "mvn -B verify",
                "jobs.build.steps[3].run",
                "./gradlew clean build",
            ),
            (
                "added",
    ...
    def test_result_30(self):
        ...
        expected_result = [
            ("removed", "on.push", None, None, None),
            ("added", None, None, "on.pull_request", None),
            (
                "changed",
            ...
            (
                "changed",
                "jobs.build.steps[0].with.go-version",
                1.13,
                "jobs.build.steps[0].with.go-version",
                1.12,
            ),
    ...
    def test_result_31(self):
        ...
        expected_result = [
            ("removed", "env.MSRV", "1.49.0", None, None),
            ("removed", "env.APPENDER_MSRV", "1.53.0", None, None),
            (
                "removed",
                "jobs.test-features-stable.steps[1]",
                {
                    "uses": "actions-rs/toolchain@v1",
                    "with": {"toolchain": "stable", "profile": "minimal", "override": True},
                },
            ...
            (
                "changed",
                "jobs.test-wasm.steps[1].uses",
                "actions-rs/toolchain@v1",
                "jobs.test-wasm.steps[1].uses",
                "dtolnay/rust-toolchain@stable",
            ),
            ("removed", "jobs.test-wasm.steps[1].with.toolchain", "stable", None, None),
            ("removed", "jobs.test-wasm.steps[1].with.override", True, None, None),
            (
                "removed",
                "jobs.cargo-hack.steps[1]",
                {
                    "uses": "actions-rs/toolchain@v1",
                    "with": {"toolchain": "stable", "profile": "minimal", "override": True},
                },
            ...
            (
                "changed",
                "jobs.warnings.steps[1].uses",
                "actions-rs/toolchain@v1",
                "jobs.warnings.steps[1].uses",
                "dtolnay/rust-toolchain@stable",
            ),
            ("removed", "jobs.warnings.steps[1].with.toolchain", "stable", None, None),
            ("removed", "jobs.warnings.steps[1].with.profile", "minimal", None, None),
            (
                "moved",
                "jobs.all_required.needs[2]",
                "cargo-hack",
                "jobs.all_required.needs[1]",
                "cargo-hack",
            ),
            (
                "moved",
                "jobs.all_required.needs[3]",
                "check-msrv",
                "jobs.all_required.needs[2]",
                "check-msrv",
            ),
            ...
            (
                "moved",
                "jobs.all_required.needs[6]",
                "test-wasm",
                "jobs.all_required.needs[4]",
                "test-wasm",
            ),
            (
                "moved",
                "jobs.all_required.needs[7]",
                "test-features-stable",
                "jobs.all_required.needs[5]",
                "test-features-stable",
            ),
            ("removed", "jobs.all_required.needs[1]", "minimal-versions", None, None),
            ("removed", "jobs.all_required.needs[4]", "check-msrv-appender", None, None),
            (
                "changed",
                "jobs.test-build-wasm.steps[1].uses",
                "actions-rs/toolchain@v1",
                "jobs.test-build-wasm.steps[1].uses",
                "dtolnay/rust-toolchain@stable",
            ),
            ("removed", "jobs.test-build-wasm.steps[1].with.toolchain", "stable", None, None),
            ("removed", "jobs.test-build-wasm.steps[1].with.override", True, None, None),
            (
                "removed",
                "jobs.test-build-wasm.steps[2]",
                {
                    "name": "build all tests",
                    "uses": "actions-rs/cargo@v1",
                    "with": {"command": "test", "args": "--no-run -p ${{ matrix.subcrate }}"},
                },
                None,
                None,
            ),
            (
                ...
                None,
                "jobs.test-build-wasm.steps[2]",
                {"name": "build all tests", "run": "cargo test --no-run -p ${{ matrix.subcrate }}"},
            ),
            (
                "changed",
                "jobs.style.steps[1].uses",
                "actions-rs/toolchain@v1",
                "jobs.style.steps[1].uses",
                "dtolnay/rust-toolchain@stable",
            ),
            ("removed", "jobs.style.steps[1].with.toolchain", "stable", None, None),
            ("removed", "jobs.style.steps[1].with.profile", "minimal", None, None),
            ("removed", "jobs.style.steps[1].with.override", True, None, None),
            (
                "removed",
                "jobs.style.steps[2]",
                {
            ...
            (
                ...
                "jobs.check.steps[2]",
                {
                    "name": "Check",
                    "uses": "actions-rs/cargo@v1",
                    "with": {"command": "check", "args": "--all --tests --benches"},
                },
                None,
                None,
            ),
            ("added", None, None, "jobs.check.steps[1]", {"uses": "dtolnay/rust-toolchain@stable"}),
            (
                "added",
                None,
                None,
                "jobs.check.steps[2]",
                {"name": "Check", "run": "cargo check --all --tests --benches"},
            ),
            (
                "added",
                None,
                None,
                "jobs.check-msrv.strategy",
                {
                    "matrix": {
                        "subcrate": [
                            "tracing-attributes",
                        ...
                        "toolchain": ["1.49.0", "stable"],
                        "exclude": [{"subcrate": "tracing-appender", "toolchain": "1.49.0"}],
                        "include": [{"subcrate": "tracing-appender", "toolchain": "1.53.0"}],
                    }
                },
            ),
            (
                "changed",
                "jobs.check-msrv.name",
                "cargo check (MSRV on ubuntu-latest)",
                "jobs.check-msrv.name",
                "cargo check (+MSRV -Zminimal-versions)",
            ),
            (
                "moved",
                "jobs.check-msrv.steps[2]",
                {
                    "name": "install Rust nightly",
                    "uses": "actions-rs/toolchain@v1",
                    "with": {"toolchain": "nightly", "profile": "minimal"},
                },
                "jobs.check-msrv.steps[1]",
                {"name": "install Rust nightly", "uses": "dtolnay/rust-toolchain@nightly"},
            ),
            (
                "removed",
                "jobs.check-msrv.steps[2].with",
                {"toolchain": "nightly", "profile": "minimal"},
                None,
                None,
            ),
            (
                "changed",
                "jobs.check-msrv.steps[2].uses",
                "actions-rs/toolchain@v1",
                "jobs.check-msrv.steps[1].uses",
            ...
            (
                ...
                "jobs.check-msrv.steps[1]",
                {
                    ...
                    "uses": "actions-rs/toolchain@v1",
                    "with": {"toolchain": "${{ env.MSRV }}", "profile": "minimal"},
                },
                "jobs.check-msrv.steps[2]",
                {
            ...
            (
                "changed",
                "jobs.check-msrv.steps[1].name",
                "install Rust ${{ env.MSRV }}",
                "jobs.check-msrv.steps[2].name",
                "install Rust ${{ matrix.toolchain }}",
            ),
            (
                "changed",
                "jobs.check-msrv.steps[1].uses",
            ...
            ("removed", "jobs.check-msrv.steps[1].with.profile", "minimal", None, None),
            (
                "changed",
                "jobs.check-msrv.steps[1].with.toolchain",
                "${{ env.MSRV }}",
                "jobs.check-msrv.steps[2].with.toolchain",
                "${{ matrix.toolchain }}",
            ),
            (
                "removed",
                "jobs.check-msrv.steps[3]",
                {
            ...
            (
                "removed",
                "jobs.check-msrv.steps[4]",
                {
                    "name": "Check",
                    "uses": "actions-rs/cargo@v1",
                    "with": {
                        "command": "check",
                        "args": "--workspace --all-features --locked --exclude=tracing-appender --exclude=tracing-examples --exclude=tracing-futures",
                        "toolchain": "${{ env.MSRV }}",
                    },
                },
                None,
                ...
                "jobs.check-msrv-appender",
                {
                    ...
                    "steps": [
                        {"uses": "actions/checkout@v3"},
                        {
                            ...
                            "uses": "actions-rs/toolchain@v1",
                            "with": {"toolchain": "${{ env.APPENDER_MSRV }}", "profile": "minimal"},
                        },
                        {
                            "name": "install Rust nightly",
                            "uses": "actions-rs/toolchain@v1",
    ...
    def test_result_32(self):
        ...
        expected_result = [
            (
                ...
                "jobs.go118.steps[4]",
                {
                    "run": "go install github.com/google/go-containerregistry/cmd/registry@latest\nregistry &\nKO_DOCKER_REPO=localhost:1338 ko build ./test/\n"
                },
                None,
                None,
            ),
            ...
            (
                ...
                None,
                "jobs.go118.steps[5]",
                {"with": {"KO_DOCKER_REPO": "localhost:1338"}, "run": "ko build ./test/"},
            ),
        ]
    ...
    def test_result_33(self):
        ...
        expected_result = [
            (
                ...
                None,
                "jobs.build.strategy",
                {"matrix": {"channel": ["esphome", "esphome-beta", "esphome-dev"]}},
            ),
            (
                "changed",
                "jobs.build.steps[1].name",
                "🚀 Run Home Assistant Add-on Lint on ESPHome",
                "jobs.build.steps[1].name",
                "🚀 Run Home Assistant Add-on Lint on ${{ matrix.channel }}",
            ),
            (
                "changed",
                "jobs.build.steps[1].with.path",
                "./esphome",
                "jobs.build.steps[1].with.path",
                "./${{ matrix.channel }}",
            ),
    ...
    def test_result_34(self):
        ...
        expected_result = [
            ("removed", "jobs.test.steps[9].with.fail_ci_if_error", True, None, None)
        ]
        ...
        expected_result = [
            (
                ...
                "jobs.test.steps[6]",
                {
                    ...
                    "env": {"TEMPLATE_NAME": "${{ matrix.template }}"},
                    "run": 'ns create myApp --template="$(pwd)/templates/packages/$TEMPLATE_NAME"\ncd myApp\nnpm install\n',
                },
                "jobs.test.steps[7]",
                {
                    "name": "Create app from template",
            ...
            (
                "moved",
                "jobs.test.steps[7]",
                {"name": "Test iOS Build", "working-directory": "myApp", "run": "ns build ios\n"},
                "jobs.test.steps[8]",
                {"name": "Test iOS Build", "working-directory": "myApp", "run": "ns build ios\n"},
            ),
            (
            ...
            (
                ...
                "jobs.test.steps[6]",
                {
                    ...
                    "run": 'SDKMANAGER=$ANDROID_HOME/cmdline-tools/latest/bin/sdkmanager\necho y | $SDKMANAGER --uninstall "build-tools;31.0.0"\n',
                },
            ),
        ]
    ...
    def test_result_36(self):
        ...
        expected_result = [
            (
                "changed",
                "jobs.build.strategy.matrix.os[1]",
                "windows-lates",
                "jobs.build.strategy.matrix.os[1]",
                "windows-latest",
            )
    ...
    def test_result_38(self):
        ...
        expected_result = [
            (
                "changed",
                "jobs.build-and-test.steps[1].with.toolchain",
                "nightly",
                "jobs.build-and-test.steps[1].with.toolchain",
                "nightly-2020-09-20",
            )
    ...
    def test_result_39(self):
        ...
        expected_result = [
            (
                "changed",
                "jobs.build-switch.steps[0].run",
                'wget "https://wii.leseratte10.de/devkitPro/devkitA64/r14 (2019-12)/devkitA64-r14-3-linux.pkg.tar.xz" && sudo dkp-pacman -U devkitA64-r14-3-linux.pkg.tar.xz --noconfirm',
                "jobs.build-switch.steps[0].run",
                'sudo dkp-pacman -Rs devkitA64 devkitA64-gdb devkita64-rules --noconfirm && wget "https://wii.leseratte10.de/devkitPro/devkitA64/r14 (2019-12)/devkitA64-r14-3-linux.pkg.tar.xz" && sudo dkp-pacman -U devkitA64-r14-3-linux.pkg.tar.xz --noconfirm',
            )
        ]
    ...
    def test_result_40(self):
        ...
        expected_result = [
            ...
            (
                ...
                "jobs.main.steps[5]",
                {
                    ...
                    "with": {
                        ...
                        "build-args": "RUST_TOOLCHAIN=${{ env.toolchain }}\n",
            ...
            (
                "changed",
                "jobs.main.steps[5].with.push",
                "${{ github.repository == 'cloud-hypervisor/rust-hypervisor-firmware' && github.event_name == 'push' }}",
                "jobs.main.steps[6].with.push",
                "${{ github.event_name == 'push' }}",
            ),
            (
                "changed",
                "jobs.main.steps[5].with.tags",
                "rusthypervisorfirmware/dev:latest",
                "jobs.main.steps[6].with.tags",
                "${{ steps.meta.outputs.tags }}",
            ),
            (
                "removed",
                "jobs.main.steps[4].if",
                "${{ github.repository == 'cloud-hypervisor/rust-hypervisor-firmware' && github.event_name == 'push' }}",
                None,
                None,
            ),
            (
                "changed",
                "jobs.main.steps[4].name",
                "Login to DockerHub",
                "jobs.main.steps[4].name",
                "Login to ghcr",
            ),
            ("added", None, None, "jobs.main.steps[4].with.registry", "${{ env.REGISTRY }}"),
            (
                "changed",
                "jobs.main.steps[4].with.username",
            ...
            (
                "changed",
                "jobs.main.steps[4].with.password",
